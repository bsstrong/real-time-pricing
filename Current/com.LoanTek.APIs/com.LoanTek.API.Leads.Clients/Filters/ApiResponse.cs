...
namespace com.LoanTek.API.Leads.Clients.Filters
{
    public class AApiResponse : IApiResponse
    {
        ...
        public static HttpResponseMessage CreateResponse(HttpStatusCode statusCode, Requests.IResponse response)
        {
            return CreateResponse(statusCode, response, new JsonMediaTypeFormatter() {SerializerSettings = Global.JsonSettings});
        }
        public static HttpResponseMessage CreateResponse(HttpStatusCode statusCode, Requests.IResponse response, JsonMediaTypeFormatter formatter)
        {
