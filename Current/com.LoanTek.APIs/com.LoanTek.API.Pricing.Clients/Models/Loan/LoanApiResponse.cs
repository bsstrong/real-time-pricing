...
namespace com.LoanTek.API.Pricing.Clients.Models.Loan
{
    ...
    /// <summary>
    /// Returns a List of <see cref="ILoanSubmission{T}"/> LoanSubmission objects based on the data points of the passed in <see cref="ILoanRequest{T}"/> LoanRequest object. 
    /// </summary>
    public class LoanApiResponse<T, TT> : IClientResponse
    {
        ...
        /// <summary>
        /// List of <see cref="LoanSubmission"/>LoanSubmission. Each LoanSubmission (a submission) contains the quotes for one user, the user's quoting information, and the request id (ClientDefinedIdentifier).
        /// </summary>
        /// <remarks>
        /// The collection of quotes being returned are Loan objects by default, but the properties returned can be limited using the ClientLoanRequest.CustomQuoteResponseJson property.
        /// </remarks>
        public List<T> Submissions { get; set; }

        /// <summary>   
        /// A copy of the <see cref="LoanRequest"/> LoanRequest sent to and used by this web service.
        /// </summary>  
        /// <remarks>
        /// This value will be null unless the property 'ReturnCopyOfLoanRequestInResponse' is set to true in the LoanApiRequest.
        /// </remarks>
        public TT LoanRequest { get; set; }
